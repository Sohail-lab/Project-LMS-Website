    ...
    return (
        <div className="bg-gray-700 w-80 h-screen hidden md:block sticky top-0">
            <div className="text-center pt-10 px-3 space-y-2">
                ...
                <NavLink to="/admin/projects" className={({isActive}) => `text-2xl text-gray-300 ${isActive ? "bg-gray-950" : "bg-transparent"} flex items-center gap-2 font-bold cursor-pointer p-3 rounded-2xl w-full`}>
                    <FolderPlus/>
                    <span>Projects</span>
                </NavLink>
            </div>
